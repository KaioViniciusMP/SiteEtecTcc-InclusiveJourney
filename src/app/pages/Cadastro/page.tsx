    ...
    return (
        <main>
            <div className="container">
                ...
                <Image src={imageCadastro} height={726} alt="Imagem de Login" />
                </section>
                <section className="segunda">
                    <form className="form">
                        ...
                        <div className="inputForm">
                            ...
                            <input type="password" className="input" placeholder="Confirmação de senha" />
                        </div>
                        ...
                        <Link className="p" href="#">Já possui uma conta?</Link>
                    </form>
                </section>
            </div>
        </main>
