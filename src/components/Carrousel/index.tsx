...
import logo1 from '../../img/estilo-de-vida-de-amigos-com-deficiencia-de-tiro-completo.jpg'
import logo2 from '../../img/Zona norte 2.svg'
import logo3 from '../../img/zona-leste-de-sao-paulo-bairros-610x406 1.svg' 
        ...
        <div className="carrousel">
            ...
            <div className="carrousel-content">
                ...
                <div className="carrousel-text">
                    ...
                    <button onClick={() => {window.location.href = '../pages/Sobre'}} style={{color: 'white'}} className="saiba-mais-button">Saiba Mais</button>
                </div>
            </div>
